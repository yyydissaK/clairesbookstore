...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" required placeholder="e.g. Johannesburg">
         </div>
         <div class="inputBox">
            <span>Province :</span>
            <input type="text" name="province" required placeholder="e.g. Gauteng">
         </div>
         <div class="inputBox">
            <span>Country :</span>
            ...
            <select name="method">
               ...
               <option value="Deliver">Free Delivery</option>
            </select>
         </div>
      </div>
